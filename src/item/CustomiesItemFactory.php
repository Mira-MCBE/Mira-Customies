...
final class CustomiesItemFactory {
	...
	public function registerItem(Item $item, string $itemTypeName): void {
		...
		if(($componentBased = $item instanceof ItemComponents)) {
			$this->itemComponentEntries[$itemTypeName] = new ItemComponentPacketEntry($itemTypeName,
		...
		$this->itemTableEntries[$itemTypeName] = new ItemTypeEntry($itemTypeName, $itemTypeId, $componentBased);
